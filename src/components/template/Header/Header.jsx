                ...
                <nav className="navbar navbar-expand-sm navbar-dark bg-primary">
                    ...
                    <ul className="navbar-nav">
                        <li className={this.state.width < 576 ? 'nav-item dropdown' : 'nav-item '}>
                            ...
                            <span onClick={this.props.selectMenu} className={this.state.width < 576 ? 'nav-link pl-1 dropdown-toggle text-white':'d-none' } id="navbarDropdown"  data-toggle={this.state.width  <578 ? 'dropdown':''} aria-haspopup="true" aria-expanded="false">
                                Dashboard 
                            </span>
                            <div className={this.state.width < 578 ? 'dropdown-menu custom-header-dropdown-menu azul border-0':'d-none'} aria-labelledby="navbarDropdown">
                        ...
                        <li className={this.state.width < 578 ? 'nav-item dropdown ' : 'nav-item'}>
                                ...
                                <span onClick={this.props.selectMenu} className={this.state.width < 578 ? 'd-none':'nav-link custom-header-nav-link text-white' } >
                                    Cadastros 
                                </span>
                                <span onClick={this.props.selectMenu} className={this.state.width < 578 ? 'nav-link pl-1 dropdown-toggle text-white':'d-none' } id="navbarDropdown" role="button" data-toggle={this.state.width < 578 ? 'dropdown':''} aria-haspopup="true" aria-expanded="false">
                                    Cadastros
                                </span>
                                <div className={this.state.width < 578 ? 'dropdown-menu custom-header-dropdown-menu azul border-0':'d-none'} aria-labelledby="navbarDropdown">
